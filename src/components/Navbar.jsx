...
const Navbar = () => {
  ...
  return (
    <div className="navbar-container fixed w-full h-[70px] flex justify-between items-center p-4 text-white font-semibold bg-purple-300 opacity:10 group-hover:opacity-30 bg-cover" style={{backgroundImage:`url(${navimg})`}}>
      <div>
